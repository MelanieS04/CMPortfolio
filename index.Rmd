...
The third visualisation is a chromagram of the most popular track on the most recent album, which is the track 'In the Blood'. The chromagram for this track shows the brightest lines for the G#/Ab. This would mean that the key of this track would probably be G# or Ab. Even though the chromagram did not seem te be correct for Your Body Is a Wonderland, it does seem to be correct for In the Blood, since In the Blood is actually in the key of G#. 
...
What can be noticed about this novelty function is that the chorus actually has the smallest peaks. The verse already shows some more peaks, but the bridge shows even more than the verse. However, the most and also the highest peaks can be found after the bridge. This is quite remarkable, since this is nothing special in this song and it does not really seem to be that loud compared to the rest of the song. It is just a short intermezzo which builds up to the next chorus. 
...
What is very noticeable here is that the keygrams and chordograms very often do not show the right key or chords of the song. Your Body Is a Wonderland is in the key of F-major, however according to the keygram it should be in D-major. In the keygram and chordogram of Your Body Is a Wonderland, there is a strange section somewhere between 140 and 180 seconds. This section is the bridge and only one chord is played here, which could be why it might have been a bit difficult to find the right key here. 
